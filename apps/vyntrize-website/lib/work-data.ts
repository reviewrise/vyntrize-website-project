...
export const cases: WorkCase[] = [
  ...
  },
  {
    ...
    challenge: 'We needed to prove our ability to build complex, scalable AI applications that solve real business problems. The challenge was to build a full-stack SaaS product that integrates seamlessly with email, calendars, and CRMs.',
    solution: 'Built a full-stack SaaS product with review response agents, calendar-aware scheduling, and lead qualification.',
    solutionDetail: [
      'Next.js 15 App Router architecture',
      'AI agents for automated review responses',
      'Calendar-aware scheduling system',
      'Lead qualification and scoring pipeline',
      'Multi-tenant database architecture',
    ],
    results: 'The platform successfully automates repetitive tasks and serves as the flagship product demonstrating our capabilities.',
    metrics: [
      { label: 'Platform', value: 'Live' },
      { label: 'Uptime', value: '99.9%' },
      { label: 'Tech', value: 'Next.js + AI' },
    ],
    deliverables: [
    ...
    quote: 'Your own product is your best case study. Use it.',
    author: 'VyntRise Team',
    role: 'Creators',
    initials: 'VR',
    timeline: 'Ongoing',
    year: '2026',
    visualType: 'screenshot',
    liveUrl: 'https://agent.vyntrise.com',
    heroImage: '/images/work/vyntrise-agent/dashboard.png',
  },
];
