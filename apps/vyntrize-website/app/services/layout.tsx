...
export const metadata: Metadata = buildMeta({
  title: 'AI Services',
  description: 'Five AI-powered service lines: AI Search, Intelligent Automation, Custom Software, Data & Analytics, and Digital Marketing. Built for measurable outcomes.',
  path: '/services',
