...
export default function TrendChart({
  ...
  if (!data || data.length === 0) {
    return (
      <div className="w-full h-[350px] bg-gray-50 rounded-lg border-2 border-dashed border-gray-300 flex items-center justify-center">
        <div className="text-center">
          <ChartBarIcon className="h-12 w-12 text-gray-400 mx-auto mb-3" />
          <p className="text-gray-600 text-sm">No trend data available</p>
          <p className="text-gray-500 text-xs mt-1">Data will appear here once analytics are collected</p>
        </div>
      </div>
    );
  }
