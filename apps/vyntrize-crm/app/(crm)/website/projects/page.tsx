        ...
        <div className="max-w-5xl space-y-6">
            <div className="flex items-center justify-between gap-4">
                <div>
                    ...
                    <p className="text-sm" style={{ color: 'var(--color-text-muted)' }}>
                        {cases.length} published · Managed in <code className="font-mono text-xs">lib/work-data.ts</code>
                    </p>
                </div>
                <Link href="https://vyntrise.com/work" target="_blank"
            ...
            <div className="rounded-2xl p-5" style={{ backgroundColor: 'var(--color-surface)', border: '1px solid var(--color-border)' }}>
                ...
                <p className="text-xs leading-relaxed mb-3" style={{ color: 'var(--color-text-muted)' }}>
                    Edit <code className="font-mono">lib/work-data.ts</code> in the CRM, then deploy. Drop images in <code className="font-mono">apps/vyntrize-website/public/images/work/</code>.
                </p>
                <Link href="https://vyntrise.com/work" target="_blank" className="inline-flex items-center gap-1.5 text-xs font-semibold" style={{ color: 'var(--color-primary)' }}>
